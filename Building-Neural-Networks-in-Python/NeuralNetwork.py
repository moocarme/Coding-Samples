...
def unpack_thetas(thetas, input_layer_size, hidden_layer_size, num_labels):
    ...
    return t1, t2
class nnet(epsilon_init = 0.12, hidden_layer_size = 35, method = 'TNC', maxiter = 100)

# epsilon_init random initialization parameter
# hidden layer size - nodes in hidden layer
# method - minimisation method
# max iter - max iterations of minisation function
